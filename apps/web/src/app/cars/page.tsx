...
export default function CarsPage() {
  ...
  const [draft, setDraft] = useState<DraftCar>({ make: "", model: "", year: "" });
  ...
  const [editDraft, setEditDraft] = useState<DraftCar>({ make: "", model: "", year: "" });
  ...
  async function handleSaveEdit() {
    ...
    try {
      ...
      const payload = {
        ...
        year: toYearNumber(editDraft.year),
      };
